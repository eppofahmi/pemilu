...
# data 1
dana_pilkada <- readRDS("dana_pilkada.rds")

# data 2
pilpres <- read_delim("pilpres.csv", ",", 
    escape_double = FALSE)

# data 3
# suara_partai <- read_csv("suara_partai.csv", 
#     trim_ws = FALSE)
```
...
SideDK {data-height=190}
-----------------------------------------------------------------------

<div style="width:808; height:900">
![](/Volumes/mydata/rSkilss/campaignABtest/lp.png)
</div>
